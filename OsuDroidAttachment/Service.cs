...
public static class Service {
    public static async Task<Transaction<Output>> AttachmentServiceApi<TDb, ELogger, UInput, TransformOutput,
        ...
        return await new AttachmentServiceApiBuilder<TDb, ELogger, UInput, TransformOutput, HandlerOutput, Output> {
            DbCreates = dbCreates,
