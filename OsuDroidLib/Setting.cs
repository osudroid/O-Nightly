...
public static class Setting {
    ...
    private static async Task<ResultErr<string>> LoadFromDbAsync() {
        ...
        Password_MinLength = settings.First(s => s is
            { SettingMainKey: ESettingMainKey.Password, SettingSubKey: ESettingSubKey.MinLength }).ValueToInt();
        Password_BCryptSalt = settings.First(s => s is
            { SettingMainKey: ESettingMainKey.Password, SettingSubKey: ESettingSubKey.BCryptSalt }).ValueToInt();
        ...
        Patreon_CampaignId = settings.First(s => s is
            { SettingMainKey: ESettingMainKey.Patreon, SettingSubKey: ESettingSubKey.CampaignId }).ValueToInt();
        ...
        Log_RequestJsonPrint = settings.First(s => s is
            { SettingMainKey: ESettingMainKey.Log, SettingSubKey: ESettingSubKey.RequestJsonPrint }).ValueToBool();
