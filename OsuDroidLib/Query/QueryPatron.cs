...
public static class QueryPatron {
    public static async Task<ResultErr<string>> SyncPatronMembersByEmails(NpgsqlConnection db,
...
";
    ...
    public static async Task<Result<Option<Patron>, string>> GetByPatronEmailAsync(NpgsqlConnection db,
        string patronEmail) {
        var sql = $@"
SELECT * 
FROM Patron
