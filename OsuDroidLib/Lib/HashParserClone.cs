...
public static class HashParser {
    private static readonly HashParser.HashFormatDescriptor OldFormatDescriptor = new HashParser.HashFormatDescriptor(1);
    private static readonly HashParser.HashFormatDescriptor NewFormatDescriptor = new HashParser.HashFormatDescriptor(2);
    ...
    public static HashInformation GetHashInformation(string hash)
    {
      ...
      return new HashInformation(hash.Substring(0, format.SettingLength), hash.Substring(1, format.VersionLength), hash.Substring(format.WorkfactorOffset, 2), hash.Substring(format.HashOffset));
    }
    ...
    private static bool IsValidBCryptVersionChar(char value) => value == 'a' || value == 'b' || value == 'x' || value == 'y';
