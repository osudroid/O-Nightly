...
public class PostLoginUsernamePassword: FastEndpoints.Endpoint<
    PostLoginUsernamePassword.PostLoginByUsernameRequest, 
...
> {
    ...
    public PostLoginUsernamePassword(
    ...
    public override void Configure() {
        Post("/api/login/by/username");
        AllowAnonymous();
    }

    public override async Task<Results<Ok<TokenTTLDto>, BadRequest<string>, InternalServerError, NotFound<string>, UnauthorizedHttpResult>> ExecuteAsync(
        PostLoginByUsernameRequest req, CancellationToken ct) {
        
        var username = req.Username;
        var password = req.Password;

        
        var authContextResult = await _authenticationProvider.GetUserAuthContextByUsername(username);
    ...
    public class PostLoginByUsernameRequest {
    ...
    public class PostLoginUsernamePasswordRequestValidation : Validator<PostLoginByUsernameRequest> {
        public PostLoginUsernamePasswordRequestValidation() {
