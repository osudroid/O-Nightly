...
using WebLoginDto = OsuDroid.Class.Dto.WebLoginDto;

namespace OsuDroid.Handler; 

public class WebLoginHandler
    : IHandler<NpgsqlCreates.DbWrapper, LogWrapper, ControllerPostWrapper<WebLoginDto>, OptionHandlerOutput<ViewWebLogin>> {
