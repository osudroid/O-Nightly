...
public class GetPlayByIdHandler
    : IHandler<NpgsqlCreates.DbWrapper, LogWrapper, ControllerPostWrapper<Api2PlayByIdDto>,
    ...
    public async ValueTask<Result<OptionHandlerOutput<ViewPlayInfoById>, string>> Handel(
        ...
        LogWrapper logger,
        ControllerPostWrapper<Api2PlayByIdDto> request) {
        ...
        if (optionRep.IsNotSet())
            return Result<OptionHandlerOutput<ViewPlayInfoById>, string>.Ok(OptionHandlerOutput<ViewPlayInfoById>
                .Empty
            );
