...
public class GetUserInfoByCookieHandler: 
    ...
    public async ValueTask<Result<OptionHandlerOutput<ViewUserInfo>, string>> Handel(
        ...
        Entities.UserInfo userInfo = result.Ok().Unwrap();
        
        return Result<OptionHandlerOutput<ViewUserInfo>, string>.Ok(OptionHandlerOutput<ViewUserInfo>.With(new ViewUserInfo {
            Id = userInfo.UserId,
