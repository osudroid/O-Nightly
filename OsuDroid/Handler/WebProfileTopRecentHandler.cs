...
public class WebProfileTopRecentHandler 
    ...
    public async ValueTask<Result<OptionHandlerOutput<ViewPlays>, string>> Handel(NpgsqlCreates.DbWrapper dbWrapper, LogWrapper logger, ControllerGetWrapper<UserIdBoxDto> request) {
        var db = dbWrapper.Db;
