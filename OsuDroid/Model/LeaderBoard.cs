...
public static class LeaderBoard {
    public static async Task<Result<List<Entities.LeaderBoardUser>, string>> AnyRegionAsync(
        NpgsqlConnection db,
        int limit) {
    ...
    public static async Task<Result<Option<Entities.LeaderBoardUser>, string>> UserAsync(
        NpgsqlConnection db,
        long userId) {
