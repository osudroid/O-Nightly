...
";
    ...
    private static Dictionary<string, Country>? CountryKeyNameShort;
    private static Dictionary<string, Country>? CountryKeyName;

    public static Country? FindByNameShort(string nameShort) {
        if (CountryKeyNameShort is null) LoadJson();

        if (CountryKeyNameShort!.TryGetValue(nameShort, out var value))
            return value;
        return null;
    }
    ...
    private static void LoadJson() {
        ...
        CountryKeyNameShort = countryKeyNameShort;
        CountryKeyName = countryKeyName;
    }
